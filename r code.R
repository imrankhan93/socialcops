...
######################################################3
boxplot(data14$modal_price~data14$Commodity,main = 'boxplot of modal prices (2014)')
boxplot(data15$modal_price~data15$Commodity,main = 'boxplot of modal prices (2015)')
boxplot(data16$modal_price~data16$Commodity,main = 'boxplot of modal prices (2016)')
...
y14$fluctuation = y14$max_price - y14$min_price
y15$fluctuation = y15$max_price - y15$min_price
y16$fluctuation = y16$max_price - y16$min_price
View(y14)
...
final = final[,c(colnames(monthly_data),"fluctuation")]
View(final)
